...
import City from "./flight/City";
import Passenger, { Gender } from "./Passenger";

function showAirlineSamples(): void {
    // Latam
...
function showFlightSamples(): void {
    // LA-226
...
function showPassengerSamples(): void {
...
export default function mainClassesAndObjects(): void {
	showAirlineSamples();
	showFlightSamples();
	showPassengerSamples();
}
